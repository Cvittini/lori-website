  ...
  return (
    <footer className="footer-container">
      ...
      <div className="footer-social">
        <a href="https://www.instagram.com/lorimar_djesus/profilecard/?igsh=MXJuajFlM3M2ejA4dA==" target="_blank" rel="noreferrer">
          <FaInstagram />
        </a>
        <a href="https://wa.me/message/B6EJJP3OGYM3H1">
          <FaWhatsapp />
        </a>
        <a
      ...
      <div className="footer-bottom">
        ...
        <a
          href="https://herbalife.com"
          target="_blank"
          rel="noreferrer"
          className="herbalife-link"
        >
